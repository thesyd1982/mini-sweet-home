...
# ===============================
# 🗺️ ZOXIDE - COMPLETELY DISABLED  
# ===============================
# Clean any existing zoxide hooks that cause corruption
unset -f _zoxide_hook 2>/dev/null || true
unset _ZOXIDE_HOOK_INITIALIZED 2>/dev/null || true

# Zoxide disabled due to shell corruption issues  
# Manual navigation available with cd/ls
# If needed later: alias j='/usr/bin/zoxide query'
